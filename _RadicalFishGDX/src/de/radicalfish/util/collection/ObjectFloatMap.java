...
/**
 * A map which has always float for values and a generic object as key. This the same as the {@link ObjectIntMap}. All
 * Credits go too Nathan Sweet
 * <p>
 * The following is copied form the {@link ObjectIntMap} :
 * <hr>
 * An unordered map where the values are ints (here floats). This implementation is a cuckoo hash map using 3 hashes,
