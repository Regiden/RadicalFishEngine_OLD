...
/**
 * The Easing class holds a set of general-purpose motion tweening functions by Robert Penner. This class is essentially
 * a port from Penner's ActionScript utility, with a few added tweaks.
 * 
 * <p>
 * Examples:
 * 
...
public interface Easing {
	 ...
	 * 
	 * @param t
	 *            the time (either frames or in seconds/milliseconds)
	 * @param b
	 *            the beginning value
	 * @param c
	 *            the value changed
	...
	public static abstract class Elastic implements Easing {
		 ...
		 * 
		 * @param amplitude
		 *            the amplitude for the elastic function
		 * @param period
		 *            the period for the elastic function
		 */
	...
	public static abstract class Back implements Easing {
		 ...
		 * 
		 * @param overshoot
		 *            the amount to overshoot by -- higher number means more overshoot and an overshoot of 0 results in
	...
	/**
	 * Back easing in/out - backtracking slightly, then reversing direction and moving to target, then overshooting
	 * target, reversing, and finally coming back to target.
	 */
